          ...
          <div className="form__inner">
            <div className="form__info">
              ...
              <p>
                ...
                <br />
                {t("Як тільки ми отримаємо Ваші дані, наш оператор зв'яжеться з Вами")}
              </p>
            </div>
            <form className="form__block" onSubmit={handleFormSubmit}>
              ...
              <div className="form__block_check">
                ...
                <label htmlFor="privacy">
                  {t("Я даю згоду на: обробку моїх персональних даних та відправку повідомлення Клініці \"Сімейний Лікар\", електронною поштою.")}
                </label>
              </div>
              <input
                type="submit"
