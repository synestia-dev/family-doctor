					...
					<div className='about__desc'>
						<div className='about__mission'>
							...
							<p>
								...
								підхід у наданні медичних послуг для населення
 								усіх вікових груп. Наші спеціалісти надають допомогу пацієнтам від 
								самого народження. Пацієнти спостерігаються у сімейних лікарів, проходять
								діагностичні обстеження, отримують консультації вузьких спеціалістів, та, 
								за необхідності,  отримують стаціонарне лікування.
							</p>
						</div>
						<div className='about__look'>
							<h4>Наш погляд</h4>
							<p>
								Стати одним з найкращих медичних закладів в якості надання медичних послуг, 
								створення комфорту та задоволення потреб пацієнтів на основі інноваційних технологій. 
							</p>
						</div>
					</div>
					...
					<div className='about__staff'>
						<div className='about__staff_card'>
							<div>
								...
								<span> генеральний директор, лікар загальної практики - сімейної медицини, лікар-педіатр</span>
							</div>
						</div>
						<div className='about__staff_card'>
							<div>
						...
						<div className='about__staff_card'>
							<div>
								...
								<span>заступник генерального директора з адміністративно-господарчої частини</span>
							</div>
						</div>
						<div className='about__staff_card'>
							<div>
					...
					<Swiper
						...
						<SwiperSlide>
							<div className='feedback'>
								...
								<p>
									Нещодавно проходила курс фізичної та психологічної реабілітації у клініці «Сімейний лікар».
 									Хочу подякувати всій мультідисциплінарній команді фізичної та психологічної реабілітації за 
									доброзичливість, професіоналізм та індивідуальний підхід до кожного пацієнта! Щиро дякую, 
									Ви найкращі
								</p>
							</div>
						</SwiperSlide>
						<SwiperSlide>
							<div className='feedback'>
								...
								<p>
									Хочу сказати дякую за такий широкий спектр послуг, яке ви нам надаєте.
 									Причому деякі з них – рідко де можна отримати. Як, наприклад, рентгенографія 
									шлунка із сульфатом барію. Дуже прихильний до себе лікар, уважний медперсонал. 
									Та й сама клініка, загалом, помітно перетворилася: і ремонт, і впорядковані входи в 
									будівлю тієї ж хірургії – все говорить про гарне керівництво, 
									як адміністрації клініки, так і громади загалом. Подальшого розвитку вам
								</p>
							</div>
						</SwiperSlide>
					</Swiper>
