        ...
        <div className="container">
          ...
          <div className="about__desc">
            <div className="about__mission">
              <h4>Наша місія</h4>
              <p>{t("Доброзичлива команда професіоналів, які ЗАВЖДИ ПОРУЧ")}</p>
            </div>
            <div className="about__look">
              <h4>Наш погляд</h4>
              <p>
                {t("По сімейному теплий підхід до кожного пацієнта в комфортних умовах, від сімейного лікаря до стаціонару 24/7")}
              </p>
            </div>
          </div>
